...
class Console_View(AbstractView):
   ...
   def show_help(self):
      print("""cls - очищення консолі від тексту
hello - стартове вітання
exit - завершення програми
showall - виводить всю наявну інформацію про всіх користувачів
userbook N - виводить інформацію про користувачів посторінково, де N - кількість записів на 1 сторінку
      example >> userbook 10
